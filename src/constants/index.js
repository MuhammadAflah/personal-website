...
const experiences = [
  {
    ...
    company_name: "Data Motion",
    icon: datamotion,
    iconBg: "",
    date: "December 2023 - Present",
    points: [
      "Designed and developed dynamic and responsive websites for multiple clients",
      "Worked on modern react libraries like Material Ui, ShadcnUi, Magic UI etc",
      "Worked with MVC frameworks to develop robust and scalable backends.",
      "Participating in code reviews and providing constructive feedback to other developers.",
      "Working on setting up data on multiple charts",
      "Created AI chatBots and video and image analysis",
    ],
  },
  {
    title: "Fullstack developer",
    company_name: "Command Rooms",
    icon: command_rooms,
    iconBg: "#383E56",
    date: "April 2023 - December 2023",
    points: [
      "Designed and developed dynamic and responsive websites",
      "Worked with REST APIs, FastApI etc to retrieve and display data from databases.",
      "Worked with MVC frameworks to develop robust and scalable backends.",
      "Participating in code reviews and providing constructive feedback to other developers.",
      "Working on setting up data on charts",
    ],
  },
...
const projects = [
  {
    ...
    image: socialmedia,
    source_code_link:
      "https://github.com/MuhammadAflah/Hashtag_SocialMedia_App.git",
  ...
  {
    name: "Netflix Clone",
    description: "Use TMDB API for fetching movie details.",
    tags: [
      {
        name: "React",
        color: "blue-text-gradient",
    ...
    image: netflix,
    source_code_link:
      "https://github.com/MuhammadAflah/Netflix-clone-react.git",
  ...
  },
  {
    ...
    image: olx,
    source_code_link:
      "https://github.com/MuhammadAflah/OLX-with-react-and-nodejs.git",
  ...
  {
    name: "Weather App",
    description: "Live weather forcast using Openweathermap API.",
    tags: [
      {
        name: "React",
        color: "blue-text-gradient",
